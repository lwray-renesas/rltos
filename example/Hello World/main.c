...
int main(void)
{
	...
	/* Create the tasks*/
	Rltos_task_create(&task0, &task0_stack[63U], Thread_0_main, 0U, true);
	Rltos_task_create(&task1, &task1_stack[63U], Thread_1_main, 0U, true);
