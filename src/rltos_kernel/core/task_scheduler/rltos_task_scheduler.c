...
/** Rltos idle task*/
static rltos_task_t idle_task_ctl;
 ...
 */
static void Task_append_to_list(p_rltos_task_list_t const list_for_append, p_rltos_task_t const task_to_append, const list_index_t list_index);
 ...
 * @param[in] list_index - index of the list to in which to append the task.
 */
static void Task_insert_in_list_after_index(p_rltos_task_list_t const list_for_append, p_rltos_task_t const task_to_append, const list_index_t list_index);
 ...
 */
static void Task_remove_from_list(p_rltos_task_t const task_to_remove, const list_index_t list_index);
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				p_rltos_task_t walk_value = idle_task_list.p_head->p_next_tctl[state_list];
