...
void Task_set_running(p_task_ctl_t const task_to_run)
{
	...
	Task_insert_in_list(&running_task_list, task_to_run, state_list);
}
/* END OF FUNCTION*/

void Task_set_idle(p_task_ctl_t const task_to_idle)
{
	Task_remove_from_list(&running_task_list, task_to_idle, state_list);
	Task_insert_in_list(&idle_task_list, task_to_idle, state_list);
}
/* END OF FUNCTION*/
